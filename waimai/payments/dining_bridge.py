# 饮食店支付接入层（批次 D）
# 把堂食/打包/外卖特有规则挂在通用支付地基之上；其它行业将来可另写 *_bridge.py。

from __future__ import annotations

from .base import PayMethodOption
from .core import build_online_pay_options, mark_payment_received
...
def build_dining_cash_option(settings, order) -> PayMethodOption | None:
...
def build_dining_buyer_pay_options(settings, order=None) -> list[PayMethodOption]:
